        ...
        "korean": {
            "system": {
                "base": """
                      ...
                      2) reasoning_effort(추론 복잡도) {{"low","medium","high"}} 별로 **중복되는 복잡도 등급을 허용하지 않고 무조건 하나씩** 총3개의 질문을 생성하세요.
                        - 해당 지표는 gpt-oss 모델의 reasoning effort를 의미합니다.
                      3) 출력 형식(반드시 준수):
                        아래 **정확한** JSON 스키마로만 출력하세요. JSON 이외의 텍스트를 포함하지 마세요.
                        [
                                {{"reasoning_effort": "low", "question": "..."}},
                                {{"reasoning_effort": "medium", "question": "..."}},
                ...
                "low": """
                      ...
                      - 해야할 일의 요구사항:
                        - 질문은 발췌문에서 유추할 수 있는 **도메인 지식, 핵심 개념, 원리, 응용**을 바탕으로 작성하세요.
                          - 단순히 텍스트에 명시된 사실을 묻지 마세요.
                          - 텍스트가 암시하는 개념적, 이론적, 또는 실무적 관점을 이끌어내세요.
                        - reasoning_effort(추론 복잡도) {{"low","medium","high"}} 별로 **중복되는 복잡도 등급을 허용하지 않고 무조건 하나씩** 총3개의 질문을 생성하세요.
                          - 해당 지표는 gpt-oss 모델의 reasoning effort를 의미합니다.
                ...
                "mid": """
                      ...
                      - 해야할 일의 요구사항:
                        - 질문은 발췌문에서 유추할 수 있는 **도메인 지식, 핵심 개념, 원리, 응용**을 바탕으로 작성하세요.
                          - 단순히 텍스트에 명시된 사실을 묻지 마세요.
                          - 텍스트가 암시하는 개념적, 이론적, 또는 실무적 관점을 이끌어내세요.
                        - 추론 복잡도를 {{"low","medium","high"}} 별로 **중복되는 복잡도 등급을 허용하지 않고 무조건 하나씩** 총3개의 질문을 생성하세요.
                          - 해당 지표는 gpt-oss 모델의 reasoning effort를 의미합니다.
                        - 출력 형식(반드시 준수): 아래 **정확한** JSON 스키마로만 출력하세요. JSON 이외의 텍스트를 포함하지 마세요.
                          [
                              {{"reasoning_effort": "low", "question": "..."}},
                ...
                "high": """
                      ...
                      - 해야할 일의 요구사항:
                        - 질문은 발췌문에서 유추할 수 있는 **도메인 지식, 핵심 개념, 원리, 응용**을 바탕으로 작성하세요.
                          - 단순히 텍스트에 명시된 사실을 묻지 마세요.
                          - 텍스트가 암시하는 개념적, 이론적, 또는 실무적 관점을 이끌어내세요.
                        - 추론 복잡도(reasoning_effort)는 {{"low","medium","high"}} 별로 **중복되는 복잡도 등급을 허용하지 않고 무조건 하나씩** 총3개의 질문을 생성하세요.
                          - 해당 지표는 gpt-oss 모델의 reasoning effort를 의미합니다.
                        - 출력 형식(반드시 준수): 아래 **정확한** JSON 스키마로만 출력하세요. JSON 이외의 텍스트를 포함하지 마세요.
                          [
                              {{"reasoning_effort": "low", "question": "..."}},
