...
def main(args):
    ...
    for level in expert_levels:
        file_path = f"sample_questions/1.{args.domain}_{level}_{args.num_of_data}.jsonl"
    ...
    # 병합된 결과 저장
    output_path = f"sample_questions/2.{args.domain}_merged_{args.num_of_data}.json"
